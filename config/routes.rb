...
Rails.application.routes.draw do
  ...
  match '/profile/sign_in' => 'user/session#new',
        :as => :signin,
        :via => :get
  match '/profile/sign_in' => 'user/session#create',
        :as => :create_session,
        :via => :post
  match '/profile/sign_out' => 'user/session#destroy',
        :as => :signout,
        :via => :get
  match '/profile/sign_up' => 'user#signup',
        :as => :signup, :via => :post
  match '/c/:email_token' => 'user/session#confirm',
        :as => :confirm,
        :via => :get
